            ...
            <nav class="navbar navbar-expand-lg navbar-light">
                ...
                <div class="collapse navbar-collapse" id="edicaMainNav">
                    <ul class="navbar-nav mx-auto mt-2 mt-lg-0">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('post.about') }}">О нас</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('post.contact') }}">Контакты</a>
                        </li>
                    </ul>
                    @auth()
                        <ul class="navbar-nav mt-2 mt-lg-0">
                            ...
                            <li class="nav-item">
                                <form action="{{ route('logout') }}" method="POST">
                                    @csrf
                                    <input type="submit" value="Выйти" role="button" class="bg-transparent border-0 nav-link">
                                </form>
                            </li>
                        </ul>
                    @endauth
